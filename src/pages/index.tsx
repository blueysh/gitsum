    ...
    return (
        <>
            ...
            <div className="max-w-[550px] py-10 mx-auto flex flex-col items-center justify-center text-white font-semibold">
                ...
                <span className="font-normal mono italic">example: <a href="https://gitsum.blueysh.me/@blueysh"><span className="underline underline-offset-1 focus:underline-offset-4 hover:underline-offset-4 transition-all duration-200">https://gitsum.blueysh.me/@blueysh</span></a></span>
